...
const { repoID, filePath, dirPath, newfileName, dstrepoID, dstfilePath, comment, server, username, password } = config;
seafileAPI.init({ server: server, username: username, password: password });
